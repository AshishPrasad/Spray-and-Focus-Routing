...
set val(seed)           0.0;   
set val(rp)   		Sr;    # Our Routing Protocol Spray & Focus Routing
set val(nn)             120;     # how many nodes are simulated
set val(start)          1.0;   # simulation time
set val(stop)           100.0;  # simulation time

set val(row)		15;
set val(col)		8;
set val(cp)             "/home/ashish/Desktop/tcl/check/scene1"
...
#for {set i 0} {$i < $val(nn)} { incr i } {
#     $ns at 75.0 "[$node_($i) agent 255] print_rtable"
#}
